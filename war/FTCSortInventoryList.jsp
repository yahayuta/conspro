...
if (listInventoryRecord != null) {
	...
	for (Iterator iterator = listInventoryRecord.iterator(); iterator.hasNext();) {
		...
		String record = "<td width=\"160\"><a href=\"javascript:void(0)\" onclick=\"loadDetailEn(" + inventoryRecord.getKey().getName() + ")\"><img src=\"FTCGetPicture?EDITID=" + inventoryRecord.getKey().getName() + "\" width=\"160\" height=\"120\" title=\"" + inventoryRecord.getProperty("OTHER") + "\"><br>" + inventoryRecord.getProperty("MANUFACTURER") + "<br>" + inventoryRecord.getProperty("NAME") + "</a></td>";
	  	out.println(record);
		count++;
	}
}
