...
public class FTCPictureUploadRentalSvlt extends HttpServlet {
	@Override
	protected void service(HttpServletRequest arg0, HttpServletResponse arg1) throws ServletException, IOException {
	    // セッションからとる
		String id =(String)arg0.getSession().getAttribute("RentalInventoryRecord");
        ...
        try {
			...
			// 一覧画面へ
			arg1.sendRedirect("FTCGetRentalInventoryList?ACCOUNT=" + (String)arg0.getSession().getAttribute("AuthACCOUNT"));
        } catch (Throwable th) {
