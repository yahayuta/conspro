...
public class FTCSeachOtherInventoryListSvlt extends HttpServlet {
	...
	protected void service(HttpServletRequest arg0, HttpServletResponse arg1) throws ServletException, IOException {
	    ...
	    filters.add(new FilterPredicate("DATA_FLG", FilterOperator.EQUAL, "5"));
	    ...
	    if ("0".equals(searchType)) {
	    	page = "/OtherInventoryListPopUp.jsp";
	    } else {
	    	page = "/OtherInventoryList.jsp";
	    }
