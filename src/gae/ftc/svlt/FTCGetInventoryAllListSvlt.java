...
public class FTCGetInventoryAllListSvlt extends HttpServlet {
	...
	protected void service(HttpServletRequest arg0, HttpServletResponse arg1) throws ServletException, IOException {
	    ...
	    if (FTCConst.PAGE_TYPE_EN.equals(page)) {
	    	rd = sc.getRequestDispatcher("/FTCInventoryListAll.jsp");
	    } else if (FTCConst.PAGE_TYPE_JA.equals(page)) {
	    	rd = sc.getRequestDispatcher("/FTCInventoryListJaAll.jsp");	
	    }
